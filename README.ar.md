<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 098" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 098｜كتاب ألوان مائية ساذج
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 098 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يحافظ **Panel 098** على الموضوع والوضع الأساسي واضحين، ثم يحوّل الصورة إلى عالم سردي صغير بخط حبر رخو وألوان مائية مسطحة وآثار فرشاة ظاهرة ومقياس رمزي ومنظور فطري وحروف يدوية مرحة. وراء البراءة الظاهرة فراغ ناضج وإيقاع غرافيكي مضبوط.

### مناسب لـ

- تبسيط الصورة من دون فقدان جوهرها العاطفي والسردي؛
- خط حبر رخو وألوان مائية أو غواش مسطحة ومنظور فطري وآثار يدوية ظاهرة؛
- ذكريات يومية وقصص ثقافية ومشاهد طريفة وفكاهة بصرية لطيفة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات؛

### بداية سريعة

> استخدم XXD Panel 098 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-098-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 098. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-098 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-098 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-098 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-098 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-098 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 098 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-098 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-098`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-098-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-098-prompt.zh-CN.md)
