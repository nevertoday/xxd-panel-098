...
Each of the 98 Panels preserves its own original brief and aesthetic logic. The table continuously lists every project from 001 through 098 with its defining style characteristics; the current project is bold.
