...
```text
/xxd-panel-098 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，098 设计在下）
2. 左右对照（原图在左，098 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-098/<fresh-task>/
...
- `references/xxd-panel-098-prompt.zh-CN.md`
- `references/xxd-panel-098-prompt.en.md`
